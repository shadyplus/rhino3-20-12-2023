...
let now = new Date,
    ...
    date = day + "." + mm + "." + year;
const massange = [{
    m: "محادثتي الرسمية عبر الإنترنت مرحبًا! أنا خوسيه إميليو  طبيب المسالك البولية وعلم الجنس . أقوم هنا بإجراء تشخيصات مجانية وتقديم توصيات شخصية ساعدت العديد من  الرجال على التخلص من مشاكلهم الجنسية . "
}, {
    m: "أعتقد انه انت هنا لانه لديك مشكلة جنسية ما . و أنا هنا اليوم لمساعدتك على التخلص من المشاكل الجنسية لديك و الضعف الجنسي . أعتقد أيضاً انك جربت العديد من المنتجات الكيميائية لتتخلص من هذه المشاكل الجنسية لا تقلق كل شيء سيكون بخير ."
}, {
    ...
    m: "شكرا على الرد. لن أطمئنك عبثًا: مشكلتك  لها عواقب إجرائية معقدة وهي يمكن ان تؤدي بك إلى العجز الجنسي و في هذه الحالة، لا فائدة من الاستعانة بالمواد الكيميائية التي ليس لها أي قيمة أو فائدة . "
}, {
    m: "عليك أن تفهم أن الضعف الجنسي  ليس مجرد مشكلة في السرير. و لكن هي مشكلة خطيرة للغاية، إذا تركتها دون حل سريع و أمن ، فإنه يمكن أن يسبب ركود السائل المنوي  و به يؤدي إلى السرطان ويمكن لهذه المشكلة  أن تقتل المصاب  في غضون بضع سنوات."
}, {
    m: "يمكن أن تتطور هذه المشكلة ببطء،لكن هذه المشكلة  مثل القنبلة الموقوتة التي لا تنفجر على الفور، ولكن لديها فرصة 100% للانفجار عاجلاً أم آجلاً."
}, {
    m: "وحتى وقت قريب، لم تكن هناك طريقة فعالة للتخلص من المشاكل الجنسية لدى الرجال  بشكل كامل. إذا تم تشخيصك انك مصاب بمشاكل جنسية او  بالعجز الجنسي، فإن الحل  الأكثر احتمالا لحالتك الذي يمكن إعطاؤه هو أي منتج كيميائي يمكنه  توسيع أوعية العضو الذكري ، ويدمرها ببطء ويجهد القلب بشكل كبير."
}, {
    ...
    m: "الحل الأكثر فعالية لزيادة إنتاج هرمون التستوستيرون و زيادة القوة الجنسية في أقل من أسبوعين هو إستخدام مكمل غذائي طبيعي مثل : \"RHINOXX\"."
}, {
    m: "بمجرد إستخدامك للمكمل الغذائي RHINOXX    ستحصل على زيادة في قوتك الجنسية و زيادة في الرغبة الجنسية في السرير. ستحصل امرأتك على 3 هزات جماع على الأقل كل ليلة ولن تتوقف عند هذا الحد."
}, {
    ...
    m: "يساعد حتى في الحالات المتقدمة والشديدة،و ينشط  وظيفة الجهاز التناسلي الذكري  و يزيد  الطاقة في أي عمر و يمكن إستخدامه لأي شخص فوق 18 عاماً . والأهم من ذلك أنه يمكن استخدامه ببساطة في المنزل. "
}, {
    m: "نجح هذا المكمل الغذائي في الحصول على رضا كل من إستخدمه لأنه منتج طبيعي 100% و حلال 100% و ليس به أي مواد كيميائية ضارة ."
}, {
    m: "يتميز هذا المنتج بتركيبته الطبيعية تماما وتركيبته الفريدة التي تؤثر على العضو الذكري مباشرةً. يحتوي على المكونات التالية:  الجينسينج الاحمر  ، نبات القراص، الماكا  ، التورين ، الزنجبيل ، تونكة علي    ."
}, {
   m: ' <img src="img/message-img.jpeg"> '
}, {
    m: "تستخدم تونكات علي   في الطب التقليدي لزيادة الطاقة وتحسين الصحة الجنسية ودعم التوازن الهرموني وتقوية الجسم بشكل عام وخاصة الخصوبة والمناعة. "
}, {
    m: "الآثار الرئيسية التي يمكن توقعها بعد استخدام المكمل الغذائي RHINOXX : زيادة الانتصاب، إطالة مدة الجماع، تكبير العضو الذكري . النشوة الجنسية الشديدة. "
}, {
    m: "العديد  من الرجال في الجزائر  الذين تناولوا RHINOXX أكدوا فعاليته منذ الإستخدام الأول، كما أدى إلى زيادة الانتصاب لديهم أكثر  واستدامة في هذا الإنتصاب لوقت طول و أيضاً ممارسة العلاقة لوقت أطول و عدة مرات. "
}, {
...
function question2() {
    $(".chat-content-list").append('<div class="chat-content-buttons-gender"><div class="chat-content-buttons-gender-block"><span class="question2M">انخفاض الرغبة الجنسية</span></div><div class="chat-content-buttons-gender-block"><span class="question2W">ضعف الإنتصاب </span></div><div class="chat-content-buttons-gender-block"><span class="question2P">سرعة القذف </span></div><div class="chat-content-buttons-gender-block"><span class="question2T">هزة الجماع السيئة</span></div></div>')
}

function choise2() {
    $(".question2M").click(() => {
        document.querySelector(".chat-content-buttons-gender").style.display = "none", myMassange("انخفاض الرغبة الجنسية"), $(".chat-content-buttons-gender").css("display", "none"), setTimeout(() => {
            process = !0
        }, 500)
    }), $(".question2W").click(() => {
        ...
        document.querySelector(".chat-content-buttons-gender").style.display = "none", myMassange("هزة الجماع السيئة"), $(".chat-content-buttons-gender").css("display", "none"), setTimeout(() => {
            process = !0
        }, 500)
    })
}
